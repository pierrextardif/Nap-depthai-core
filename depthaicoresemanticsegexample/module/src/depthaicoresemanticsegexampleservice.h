...
namespace nap
{
	class NAPAPI DepthaiCoreSemanticSegExampleService : public Service
	{
		RTTI_ENABLE(Service)
	public:
		// Default Constructor
		DepthaiCoreSemanticSegExampleService(ServiceConfiguration* configuration) : Service(configuration)	{ }
