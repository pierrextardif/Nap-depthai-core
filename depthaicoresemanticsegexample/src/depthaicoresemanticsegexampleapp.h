...
namespace nap
{
	 ...
	 */
	class DepthaiCoreSemanticSegExampleApp : public App
	{
		RTTI_ENABLE(App)
	public:
		/**
		 ...
		 */
		DepthaiCoreSemanticSegExampleApp(nap::Core& core) : App(core) { }
	...
	private:
		...
		ObjectPtr<EntityInstance>	mOakCameraEntity = nullptr;
		ObjectPtr<EntityInstance>	mBackgroundEntity = nullptr;
		ObjectPtr<EntityInstance>	mOrthoCameraEntity = nullptr;

		nap::RenderOakCameraComponentInstance* OakCamRenderer = nullptr;
