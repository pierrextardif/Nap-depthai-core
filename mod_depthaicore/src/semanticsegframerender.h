...
namespace nap
{
	...
	class NAPAPI SemanticSegFrameRender : public Device
	{
		RTTI_ENABLE(Device)    
	...
	public :
		...
		SemanticSegFrameRender(DepthAICoreService& service);
	...
	using SemanticSegFrameRenderObjectCreator = rtti::ObjectCreator<SemanticSegFrameRender, DepthAICoreService>;
