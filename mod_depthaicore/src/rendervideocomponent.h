...
namespace nap
{
	...
	public:
		ResourcePtr<TestFrameRender>		testFrameRender = nullptr;								///< Property: 'VideoPlayer' the video player to render to texture
	...
	private:
		TestFrameRender*			testFrameRender = nullptr;								///< Video player to render	
